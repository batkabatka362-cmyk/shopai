"""Tests for product_lifecycle applier thrash wireup (W923)."""
...
def _patch_router():
    ...
    return patch(
        "engines.product_lifecycle.lifecycle_applier."
        "_get_router",
...
class TestThrashWireup:
    ...
    def test_calm_store_archives_normally(self, monkeypatch):
