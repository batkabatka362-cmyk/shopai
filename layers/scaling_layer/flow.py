"""Scaling Layer — flow orchestrator.

Pipeline (sequential):
  marketplace → infinite_scaling

Both engines are REQUIRED. Failure at any step halts the layer.
"""
...
from .config import SCALING_LAYER_CONFIG

logger = logging.getLogger(__name__)


class ScalingLayerFlow:
    """Scaling Layer — orchestrates scaling engines sequentially."""

    LAYER_NAME = "scaling_layer"

    def run(self, input_payload: dict[str, Any]) -> dict[str, Any]:
        """Run the full scaling-layer pipeline.
        ...
        required = set(SCALING_LAYER_CONFIG["required_engines"])
        engine_names = SCALING_LAYER_CONFIG["engines"]
