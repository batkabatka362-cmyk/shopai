"""Execution Layer — flow orchestrator.

Pipeline (strictly sequential):
  execution_intelligence → time_intelligence → autonomous_decision
  → autonomous_control → autonomous_execution
...
from .config import EXECUTION_LAYER_CONFIG

logger = logging.getLogger(__name__)


class ExecutionLayerFlow:
    """Execution Layer — orchestrates autonomous-execution engines sequentially."""

    LAYER_NAME = "execution_layer"

    def run(self, input_payload: dict[str, Any]) -> dict[str, Any]:
        """Run the full execution-layer pipeline.
        ...
        required = set(EXECUTION_LAYER_CONFIG["required_engines"])
        engine_names = EXECUTION_LAYER_CONFIG["engines"]
