"""HelpdeskBaseAdapter — shared base for customer support adapters.

Concrete adapters (Intercom today; Zendesk, Freshdesk later) inherit
this class and override vendor-specific hooks.

Capabilities:
  * HELPDESK_LIST_CONVERSATIONS — list open/recent conversations
  * HELPDESK_SEND_REPLY         — reply to a conversation
  * HELPDESK_SEARCH_CONTACTS    — search customer contacts
  * HELPDESK_CREATE_TICKET      — create a new conversation/ticket
"""
...
class HelpdeskBaseAdapter(BaseAdapter):
    """Abstract base for helpdesk / customer support adapters."""
    ...
    def _execute(
        ...
        dispatch = {
            Capability.HELPDESK_LIST_CONVERSATIONS: self._do_list_conversations,
            Capability.HELPDESK_SEND_REPLY: self._do_send_reply,
            Capability.HELPDESK_SEARCH_CONTACTS: self._do_search_contacts,
            Capability.HELPDESK_CREATE_TICKET: self._do_create_ticket,
        }
