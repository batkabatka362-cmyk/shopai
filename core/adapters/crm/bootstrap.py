"""CRM adapter bootstrap.

Single entry point that instantiates every CRM adapter and
...
def register_all(
    ...
    """Instantiate every CRM adapter and register it.
    ...
    for cls in _CRM_ADAPTER_CLASSES:
        try:
            adapter = cls()
    ...
    logger.info(
        "CRM adapters registered: %d total, %d configured",
