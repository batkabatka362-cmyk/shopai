...
Concrete adapters (ElevenLabs today; Google TTS, Amazon Polly
later) inherit this class and override vendor-specific hooks.

Capabilities:
  * VOICE_TEXT_TO_SPEECH — convert text to audio
...
class VoiceBaseAdapter(BaseAdapter):
    """Abstract base for voice/TTS adapters."""
    ...
    def _execute(
        ...
        dispatch = {
            Capability.VOICE_TEXT_TO_SPEECH: self._do_text_to_speech,
            Capability.VOICE_LIST_VOICES: self._do_list_voices,
        }
