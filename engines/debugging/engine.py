...
Input:   ['error_data', 'system_logs']
Output:  ['diagnosis', 'fix_recommendations']
...
class DebuggingEngine(BaseEngine):
    ...
    def _step_analyze(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "analyzer",
            f"Analyze for debugging: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_execute(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "worker",
            f"Execute debugging task: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_enhance(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "creative",
            f"Enhance debugging output: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_validate(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "validator",
            f"Validate debugging output quality: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
