...
Purpose: Implement growth feedback loops
Input:   ['loop_data', 'metrics']
Output:  ['loop_analysis', 'optimization_actions']
...
class GrowthLoopEngine(BaseEngine):
    ...
    def _step_analyze(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "analyzer",
            f"Analyze for growth_loop: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_execute(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "worker",
            f"Execute growth_loop task: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_enhance(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "creative",
            f"Enhance growth_loop output: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_validate(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "validator",
            f"Validate growth_loop output quality: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
