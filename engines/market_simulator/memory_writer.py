"""Market Simulator Engine — memory writer.

Persists market simulation results to disk for future reference.
"""
...
def write_simulation_result(
    ...
    """Write a market simulation result record to memory."""
    try:
        ...
        record: dict[str, Any] = {
            ...
            "risk_analysis": copy.deepcopy(risk_analysis),
            "outcome_actual": None,
        }
