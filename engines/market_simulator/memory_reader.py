"""Market Simulator Engine — memory reader.

Reads past market simulation records from memory storage.
"""
...
def read_past_simulations(limit: int = 10) -> dict[str, Any]:
    """Read past market simulation records."""
    try:
