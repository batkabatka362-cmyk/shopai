...
Input:   ['transaction_data', 'risk_signals']
Output:  ['fraud_assessment', 'blocked_actions']
...
class FraudEngine(BaseEngine):
    ...
    def _step_enhance(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "creative",
            f"Enhance fraud output: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_validate(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "validator",
            f"Validate fraud output quality: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
