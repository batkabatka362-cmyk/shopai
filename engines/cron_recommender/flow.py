"""Cron Recommender — Pattern Q envelope."""
...
from .recommender import platform_template, recommend

logger = logging.getLogger(__name__)


class CronRecommenderEngine:
    ENGINE_NAME = "cron_recommender"
    ...
    def run(
        ...
        rec = recommend()
        out = asdict(rec)
        out["platform_template"] = platform_template(rec)
        out["next_action"] = (
            f"Recommended {rec.interval_hours:.0f}h "
