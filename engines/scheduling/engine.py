...
Purpose: Schedule tasks and events optimally
Input:   ['tasks', 'constraints']
Output:  ['schedule', 'resource_allocation']
...
class SchedulingEngine(BaseEngine):
    engine_name = "scheduling"
    required_input_fields = ['tasks', 'constraints']
    required_output_fields = ['schedule', 'resource_allocation']
    ...
    def _step_analyze(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "analyzer",
            f"Analyze for scheduling: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_execute(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "worker",
            f"Execute scheduling task: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_enhance(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "creative",
            f"Enhance scheduling output: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_validate(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "validator",
            f"Validate scheduling output quality: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
