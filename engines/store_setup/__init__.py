...
Modules:
  ...
  * ``locale_markets`` -- niche-aware market + currency
    expansion recommendations (e.g. beauty/fashion open
    UK + EU + AU Day 1; food domestic-only). Output is
    drop-in for ``SHOPIFY_CREATE_MARKET``.
