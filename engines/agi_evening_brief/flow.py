"""AGI Evening Brief — Pattern Q envelope."""
...
from .briefer import build_evening_brief

logger = logging.getLogger(__name__)


class AgiEveningBriefEngine:
    ENGINE_NAME = "agi_evening_brief"
    ...
    def run(
        ...
        brief = build_evening_brief(
            store_id=store_id, window_hours=window_h,
        )
