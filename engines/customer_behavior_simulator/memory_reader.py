"""Customer Behavior Simulator Engine — memory reader.

Reads past customer behavior simulation records from memory storage.
"""
...
def read_past_behavior_sims(limit: int = 10) -> dict[str, Any]:
    try:
