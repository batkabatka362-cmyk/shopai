...
Input:   ['ux_data', 'user_feedback']
Output:  ['ux_recommendations', 'design_changes']
...
class UxEngine(BaseEngine):
    ...
    def _step_validate(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "validator",
            f"Validate ux output quality: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
