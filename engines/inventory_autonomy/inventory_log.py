...
_LOG_PATH = Path("data") / "inventory_log.json"
...
class InventoryEvent:
    ...
    location_id: str = ""
    store_id: str = ""
    action: str = ""              # reorder / restock / adjust
...
def record_inventory_event(event: InventoryEvent) -> None:
