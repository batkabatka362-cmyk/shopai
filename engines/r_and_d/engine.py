...
Input:   ['research_topic', 'constraints']
Output:  ['research_findings', 'development_plan']
...
class RAndDEngine(BaseEngine):
    engine_name = "r_and_d"
    required_input_fields = ['research_topic', 'constraints']
    required_output_fields = ['research_findings', 'development_plan']
    ...
    def _step_analyze(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "analyzer",
            f"Analyze for r_and_d: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_execute(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "worker",
            f"Execute r_and_d task: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_enhance(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "creative",
            f"Enhance r_and_d output: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_validate(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "validator",
            f"Validate r_and_d output quality: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
