...
Purpose: Create and optimize advertisements
Input:   ['ad_brief', 'target_audience']
Output:  ['ad_creatives', 'targeting_params']
...
class AdsEngine(BaseEngine):
    ...
    def _step_validate(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "validator",
            f"Validate ads output quality: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
