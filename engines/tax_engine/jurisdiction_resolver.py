...
Determines the applicable tax type and jurisdictions based on
origin/destination addresses. Resolves state, county, city for US;
country rate for VAT; GST for AU/NZ/CA.
...
_GST_COUNTRIES = {"AU", "NZ", "CA", "SG", "IN", "MY"}


# ---------------------------------------------------------------------------
# US ZIP prefix to state mapping (first 3 digits)
# ---------------------------------------------------------------------------
...
_ZIP_PREFIX_TO_STATE: dict[str, str] = {
    ...
    "640": "KS", "641": "MO", "644": "MO", "645": "MO", "646": "MO",
...
# ---------------------------------------------------------------------------
# Major city/county identification by ZIP prefix
# ---------------------------------------------------------------------------

_ZIP_CITY_MAP: dict[str, dict[str, str]] = {
    # Texas
    "750": {"city": "Dallas", "county": "Dallas County"},
    "751": {"city": "Dallas", "county": "Dallas County"},
    "752": {"city": "Dallas", "county": "Dallas County"},
    "760": {"city": "Fort Worth", "county": "Tarrant County"},
    "761": {"city": "Fort Worth", "county": "Tarrant County"},
    "770": {"city": "Houston", "county": "Harris County"},
    "771": {"city": "Houston", "county": "Harris County"},
    "772": {"city": "Houston", "county": "Harris County"},
    "773": {"city": "Houston", "county": "Harris County"},
    "782": {"city": "San Antonio", "county": "Bexar County"},
    "783": {"city": "San Antonio", "county": "Bexar County"},
    "787": {"city": "Austin", "county": "Travis County"},
    "788": {"city": "Austin", "county": "Travis County"},
    # California
    "900": {"city": "Los Angeles", "county": "Los Angeles County"},
    "901": {"city": "Los Angeles", "county": "Los Angeles County"},
    "902": {"city": "Los Angeles", "county": "Los Angeles County"},
    "941": {"city": "San Francisco", "county": "San Francisco County"},
    "950": {"city": "San Jose", "county": "Santa Clara County"},
    "951": {"city": "San Jose", "county": "Santa Clara County"},
    "921": {"city": "San Diego", "county": "San Diego County"},
    "920": {"city": "San Diego", "county": "San Diego County"},
    # New York
    "100": {"city": "New York City", "county": "New York County"},
    "101": {"city": "New York City", "county": "New York County"},
    "102": {"city": "New York City", "county": "New York County"},
    "103": {"city": "Staten Island", "county": "Richmond County"},
    "104": {"city": "Bronx", "county": "Bronx County"},
    "110": {"city": "Queens", "county": "Queens County"},
    "111": {"city": "Brooklyn", "county": "Kings County"},
    "112": {"city": "Brooklyn", "county": "Kings County"},
    "113": {"city": "Queens", "county": "Queens County"},
    "114": {"city": "Jamaica", "county": "Queens County"},
    "140": {"city": "Buffalo", "county": "Erie County"},
    "141": {"city": "Buffalo", "county": "Erie County"},
    "142": {"city": "Buffalo", "county": "Erie County"},
    "143": {"city": "Niagara Falls", "county": "Niagara County"},
    "144": {"city": "Rochester", "county": "Monroe County"},
    "145": {"city": "Rochester", "county": "Monroe County"},
    "146": {"city": "Rochester", "county": "Monroe County"},
    # Illinois
    "606": {"city": "Chicago", "county": "Cook County"},
    "607": {"city": "Chicago", "county": "Cook County"},
    "608": {"city": "Chicago Suburbs", "county": "Cook County"},
    # Florida
    "330": {"city": "Miami", "county": "Miami-Dade County"},
    "331": {"city": "Miami", "county": "Miami-Dade County"},
    "332": {"city": "Miami", "county": "Miami-Dade County"},
    "327": {"city": "Orlando", "county": "Orange County"},
    "328": {"city": "Orlando", "county": "Orange County"},
    "336": {"city": "Tampa", "county": "Hillsborough County"},
    "337": {"city": "Tampa", "county": "Hillsborough County"},
    # Pennsylvania
    "150": {"city": "Pittsburgh", "county": "Allegheny County"},
    "151": {"city": "Pittsburgh", "county": "Allegheny County"},
    "152": {"city": "Pittsburgh", "county": "Allegheny County"},
    "190": {"city": "Philadelphia", "county": "Philadelphia County"},
    "191": {"city": "Philadelphia", "county": "Philadelphia County"},
    # Washington
    "980": {"city": "Seattle", "county": "King County"},
    "981": {"city": "Seattle", "county": "King County"},
    # Georgia
    "303": {"city": "Atlanta", "county": "Fulton County"},
    "304": {"city": "Atlanta", "county": "Fulton County"},
    # Michigan
    "481": {"city": "Detroit", "county": "Wayne County"},
    "482": {"city": "Detroit", "county": "Wayne County"},
    # Ohio
    "441": {"city": "Cleveland", "county": "Cuyahoga County"},
    "442": {"city": "Cleveland", "county": "Cuyahoga County"},
    "452": {"city": "Cincinnati", "county": "Hamilton County"},
    "432": {"city": "Columbus", "county": "Franklin County"},
    "430": {"city": "Columbus", "county": "Franklin County"},
    "431": {"city": "Columbus", "county": "Franklin County"},
    # Massachusetts
    "021": {"city": "Boston", "county": "Suffolk County"},
    "022": {"city": "Boston", "county": "Suffolk County"},
    # Colorado
    "802": {"city": "Denver", "county": "Denver County"},
    "803": {"city": "Denver", "county": "Denver County"},
    # Arizona
    "850": {"city": "Phoenix", "county": "Maricopa County"},
    "851": {"city": "Phoenix", "county": "Maricopa County"},
    "852": {"city": "Phoenix", "county": "Maricopa County"},
    # Minnesota
    "554": {"city": "Minneapolis", "county": "Hennepin County"},
    "551": {"city": "St. Paul", "county": "Ramsey County"},
    # Oregon
    "972": {"city": "Portland", "county": "Multnomah County"},
    # Nevada
    "891": {"city": "Las Vegas", "county": "Clark County"},
    "890": {"city": "Las Vegas", "county": "Clark County"},
    # Missouri
    "631": {"city": "St. Louis", "county": "St. Louis County"},
    "641": {"city": "Kansas City", "county": "Jackson County"},
    # Tennessee
    "372": {"city": "Nashville", "county": "Davidson County"},
    "381": {"city": "Memphis", "county": "Shelby County"},
    # Louisiana
    "701": {"city": "New Orleans", "county": "Orleans Parish"},
    # Indiana
    "462": {"city": "Indianapolis", "county": "Marion County"},
}
...
def resolve_jurisdiction(
    ...
    """Resolve tax jurisdictions from origin/destination addresses.

    Args:
        origin: Origin address dict.
        destination: Destination address dict.
        tax_type: One of 'auto', 'sales_tax', 'vat', 'gst'.

    Returns:
        Structured dict with jurisdiction resolution.
    """
    try:
        ...
        is_nexus = origin_country == dest_country

        if resolved_type == "sales_tax":
            jurisdictions = _resolve_us_jurisdictions(destination)
        elif resolved_type == "vat":
            jurisdictions = _resolve_vat_jurisdictions(dest_country)
        elif resolved_type == "gst":
            jurisdictions = _resolve_gst_jurisdictions(dest_country, destination)
        else:
            return _fail(f"Unknown tax type: {resolved_type}")

        if not jurisdictions:
            return _fail(f"Could not resolve jurisdictions for {dest_country}")

        return {
            "status": "success",
            "country": dest_country,
            "tax_type": resolved_type,
...
def _detect_tax_type(country_code: str) -> str:
    ...
    if country_code == "US":
        return "sales_tax"
    if country_code in _EU_COUNTRIES:
        return "vat"
    if country_code in _GST_COUNTRIES:
        return "gst"
    # Default to VAT for other countries
    return "vat"


def _resolve_us_jurisdictions(
    destination: dict[str, Any],
) -> list[dict[str, str]]:
    """Resolve US state, county, city jurisdictions from address."""
    jurisdictions: list[dict[str, str]] = []

    zip_code = str(destination.get("zip", "")).strip()
    province = str(destination.get("province", "")).upper().strip()
    city = str(destination.get("city", "")).strip()

    # Determine state from province field or ZIP
    state = province
    if not state and zip_code and len(zip_code) >= 3:
        prefix = zip_code[:3]
        state = _ZIP_PREFIX_TO_STATE.get(prefix, "")
    ...
    # County and city from ZIP lookup
    if zip_code and len(zip_code) >= 3:
        prefix = zip_code[:3]
        city_info = _ZIP_CITY_MAP.get(prefix, {})
        county = city_info.get("county", "")
        resolved_city = city_info.get("city", city)

        if county:
            jurisdictions.append({
                "name": county,
                "type": "county",
                "code": f"US-{state}-{county.replace(' ', '_').upper()}",
            })
        if resolved_city:
            jurisdictions.append({
                "name": resolved_city,
                "type": "city",
                "code": f"US-{state}-{resolved_city.replace(' ', '_').upper()}",
            })

    return jurisdictions


def _resolve_vat_jurisdictions(
    country_code: str,
) -> list[dict[str, str]]:
    """Resolve VAT jurisdictions for EU countries."""
    return [{
        "name": country_code,
        "type": "country",
        "code": country_code,
...
def _resolve_gst_jurisdictions(
    country_code: str,
    destination: dict[str, Any],
) -> list[dict[str, str]]:
    """Resolve GST jurisdictions."""
    jurisdictions: list[dict[str, str]] = [{
        "name": country_code,
        "type": "country",
        "code": country_code,
    ...
    # Canada has provincial sales tax in addition to federal GST
    if country_code == "CA":
    ...
    # Australia has state-level considerations
    if country_code == "AU":
