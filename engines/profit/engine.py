...
Purpose: Optimize profit margins
Input:   ['revenue_data', 'cost_data']
Output:  ['profit_analysis', 'margin_recommendations']
...
class ProfitEngine(BaseEngine):
    ...
    required_output_fields = ['profit_analysis', 'margin_recommendations']
    ...
    def _step_execute(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "worker",
            f"Execute profit task: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_enhance(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "creative",
            f"Enhance profit output: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_validate(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "validator",
            f"Validate profit output quality: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
