...
Purpose: Execute planned actions reliably
Input:   ['action_plan', 'execution_params']
Output:  ['execution_results', 'status_report']
...
class ExecutionEngine(BaseEngine):
    ...
    required_input_fields = ['action_plan', 'execution_params']
    required_output_fields = ['execution_results', 'status_report']
    ...
    def _step_analyze(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "analyzer",
            f"Analyze for execution: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_execute(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "worker",
            f"Execute execution task: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_enhance(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "creative",
            f"Enhance execution output: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_validate(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "validator",
            f"Validate execution output quality: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
