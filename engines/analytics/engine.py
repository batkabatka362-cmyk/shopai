...
Purpose: Analyze business performance metrics
Input:   ['metrics_data', 'time_range']
Output:  ['analysis_report', 'key_insights']
...
class AnalyticsEngine(BaseEngine):
    ...
    required_input_fields = ['metrics_data', 'time_range']
    required_output_fields = ['analysis_report', 'key_insights']
    ...
    def _step_analyze(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "analyzer",
            f"Analyze for analytics: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_execute(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "worker",
            f"Execute analytics task: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_enhance(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "creative",
            f"Enhance analytics output: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_validate(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "validator",
            f"Validate analytics output quality: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
