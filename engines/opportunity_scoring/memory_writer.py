"""Opportunity Scoring Engine — memory writer."""
...
def write_scoring_result(scored: list[dict[str, Any]], recommended: dict[str, Any]) -> dict[str, Any]:
    try:
        ...
        record = {
            ...
            "top_score": recommended.get("score", 0),
            "outcome_actual": None,
        }
        _ensure_memory_dir()
