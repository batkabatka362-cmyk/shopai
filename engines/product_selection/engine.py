...
Purpose: Select winning products from candidates
...
class ProductSelectionEngine(BaseEngine):
    ...
    def _step_analyze(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "analyzer",
            f"Analyze for product_selection: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_execute(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "worker",
            f"Execute product_selection task: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_enhance(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "creative",
            f"Enhance product_selection output: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_validate(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "validator",
            f"Validate product_selection output quality: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
