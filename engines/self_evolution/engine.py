...
class SelfEvolutionEngine(BaseEngine):
    engine_name = "self_evolution"
    required_input_fields = ['evolution_data', 'adaptation_goals']
    required_output_fields = ['evolution_plan', 'capability_updates']
