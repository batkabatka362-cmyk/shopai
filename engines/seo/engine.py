...
Purpose: Optimize search engine visibility
Input:   ['site_data', 'keywords']
Output:  ['seo_recommendations', 'keyword_strategy']
...
class SeoEngine(BaseEngine):
    ...
    def _step_validate(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "validator",
            f"Validate seo output quality: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
