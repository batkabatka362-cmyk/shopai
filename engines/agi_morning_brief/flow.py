"""AGI Morning Brief — Pattern Q envelope."""
...
from .briefer import build_morning_brief

logger = logging.getLogger(__name__)


class AgiMorningBriefEngine:
    ENGINE_NAME = "agi_morning_brief"
    ...
    def run(
        ...
        persist = bool(data.get("persist_snapshot"))

        brief = build_morning_brief(
            store_id=store_id,
            persist_snapshot=persist,
        )
        return self._success(asdict(brief), start)
