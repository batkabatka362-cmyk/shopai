...
Purpose: Control and reduce operational costs
Input:   ['cost_data', 'budget']
Output:  ['cost_analysis', 'reduction_plan']
...
class CostEngine(BaseEngine):
    engine_name = "cost"
    required_input_fields = ['cost_data', 'budget']
    required_output_fields = ['cost_analysis', 'reduction_plan']
    ...
    def _step_enhance(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "creative",
            f"Enhance cost output: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
    ...
    def _step_validate(self, step_name: str, data: dict[str, Any]) -> StepResult:
        result = self._model_router.execute(
            "validator",
            f"Validate cost output quality: " + str(data),
            context=data,
        )
        return StepResult(
            step_name=step_name,
