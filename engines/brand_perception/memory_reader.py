"""Brand Perception Engine — memory reader.

Reads past brand perception records from memory storage.
Used to track perception trends over time.
"""
...
def read_past_perceptions(
    limit: int = 10,
) -> dict[str, Any]:
    """Read past brand perception records.
...
def find_similar_past_run(input_data: dict[str, Any]) -> dict[str, Any] | None:
    ...
    result = read_past_perceptions(limit=50)
