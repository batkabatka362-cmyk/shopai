...
def _cmd_autonomous_cycle(args) -> None:
    ...
    try:
        ...
        regs_list = find_regressions(
            min_drop=3.0,
            baseline_window_seconds=86400.0 * 7.0,
            latest_window_seconds=86400.0 * 1.0,
            min_baseline_samples=3,
        )
        chronic_list = find_chronic_warnings(
            sample_window_seconds=86400.0 * 7.0,
            min_samples=3,
            healthy_score_floor=7,
        )
...
def _audit_data_files() -> dict[str, Any]:
    ...
    files = [
        ...
        ("cycle_overrides", "data/cycle_overrides.json",
         "dict"),
        ("cycle_pause", "data/cycle_pause.json",
         "dict"),
        ("cycle_pause_history",
         "data/cycle_pause_history.json", "list"),
        ("auto_demote_history",
